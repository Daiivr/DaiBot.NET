...
public static class BreedableSpeciesGenerator
{
    ...
    private static readonly List<string> BreedableSpeciesNames = new List<string>
    {
        ...
        "Chimchar","Chinchou","Clauncher","Clefable","Clodsire","Combee","Cottonee","Cramorant","Cranidos","Croagunk","Cubchoo",
        "Cufant","Cutiefly","Cyndaquil","Deerling","Deino","Dewpider","Diglett","Diglett-Alola","Doduo","Donphan","Dratini","Dreepy","Drifloon","Drilbur",
        "Drowzee","Ducklett","Dunsparce","Eevee","Electabuzz","Ekans","Espurr","Exeggcute","Feebas","Fennekin","Fidough",
        ...
        "Grookey","Growlithe","Growlithe-Hisui","Grubbin","Gulpin","Chansey","Hatenna","Hippopotas","Hoothoot","Hoppip","Horsea","Houndour","Igglybuff","Inkay","Joltik","Jumpluff","Klawf","Koffing","Krabby",
        "Kricketot","Larvesta","Lechonk","Litleo","Litten","Litwick","Lokix","Lotad","Lucario","Lycanroc","Magby","Magikarp","Magnemite",
        "Makuhita","Mankey","Mareep","Marill","Maschiff","Meditite","Meowth","Meowth-Galar","Meowth-Alola","Mienfoo","Minccino","Minun","Morgrem","Mudbray",
        "Murkrow","Nacli","Noibat","Nosepass","Numel","Nymble","Oddish","Oricorio","Orthworm","Oshawott","Pawmi","Pawniard","Petilil",
        "Phanpy","Pikachu","Pidgey","Pikipek","Pineco","Piplup","Plusle","Poliwag","Ponyta","Poochyena","Popplio","Psyduck",
        "Quaxly","Ralts","Rellor","Rockruff","Rolycoly","Rookidee","Rowlet","Rufflet","Salandit","Sandile","Sandshrew","Sandygast",
