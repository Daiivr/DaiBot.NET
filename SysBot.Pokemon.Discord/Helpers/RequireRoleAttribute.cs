...
public sealed class RequireRoleAttribute(string RoleName) : PreconditionAttribute
{
    ...
    public override Task<PreconditionResult> CheckPermissionsAsync(ICommandContext context, CommandInfo command, IServiceProvider services)
    {
        ...
        return Task.FromResult(PreconditionResult.FromError($"<a:warning:1206483664939126795> {context.User.Mention} debe tener un rol llamado {RoleName} para ejecutar este comando."));
    }
}
